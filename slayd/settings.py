...
ALLOWED_HOSTS = ['http://localhost:3000', '3.110.40.235', '127.0.0.1', 'api.slayd.in', '43.204.235.28', 'https://slayd.in', '13.232.75.180', '172.31.4.139', 'test.api.slayd.in']
...
MIDDLEWARE = [
    ...
    'middleware.metrics_middleware.MetricsMiddleware',
]
